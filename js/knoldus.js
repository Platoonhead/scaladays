...
function contactusMap() {
    ...
    var myLatlng, can, patel, mapOptions, marker, i;
    var myLatlng = [
        ['India, Noida', 28.546651, 77.40312599999993],
        ['India, West Patel nagar', 28.6544346, 77.16887999999994],
        ['Canada, Toronto', 43.653908, -79.384293],
        ['Chicago, USA', 41.881832, -87.623177],
    ...
    for( i = 0; i < myLatlng.length; i++ ) {
        var position = new google.maps.LatLng(myLatlng[i][1], myLatlng[i][2]);
